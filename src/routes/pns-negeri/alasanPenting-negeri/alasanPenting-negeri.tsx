      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="rounded-3xl shadow-2xl p-8 border-b-2 ">
          ...
          <div className="mt-8">
            ...
            <div className=" rounded-3xl shadow-xl p-6 mb-4 flex items-center gap-4">
            ...
            <div className=" rounded-3xl shadow-xl p-6 mb-4 flex items-start gap-4">
              <div className="flex-1">
              ...
              <div className="px-6 py-3 rounded-xl shadow-lg shrink-0">
                <Link
                  to="/ttd-cuti-swasta"
                  className=" bg-primary hover:bg-secondary font-bold px-4 py-2 rounded shadow"
                >
                  CHECK
                </Link>
              </div>
            ...
            <div className=" rounded-3xl shadow-xl p-6 flex items-center gap-4">
              <div className="rounded-full w-16 h-16 flex items-center justify-center shadow-lg shrink-0">
        ...
        <div className="p-6 flex justify-">
          <a
            ...
            className="bg-primary hover:b-secondary font-semibold px-6 py-2 rounded-md shadow transition"
          >
            Kembali
          </a>
        </div>

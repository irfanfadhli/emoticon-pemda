...
export const Route = createFileRoute("/swasta/cltn/")({
  component: Cltn,
});
      ...
      <div className="max-w-6xl mx-auto ">
        ...
        <div className=" rounded-2xl shadow-2xl p-8 mb-6  border-4 ">
          ...
          <ul className="space-y-4">
            {[
              "MENGIKUTI ATAU MENDAMPINGI SUAMI/ ISTERI TUGAS NEGARA/TUGASBELAJAR DI DALAM/LUARNEGERI;",
          ...
          <div className="space-y-4">
            ...
            <div className="bg-linear-to-r   rounded-xl p-6  shadow-lg border-2 ">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-xl font-bold">Keputusan Kepala BKN</h3>
              </div>
        ...
        <div className=" rounded-2xl shadow-2xl p-8 border-4 ">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-linear-to-br    rounded-xl p-6  border-4  shadow-2xl">
              <div className="flex items-center gap-4">
